  ...
  const onSubmit = async (data: FormData): Promise<void> => {
    ...
    try {
      ...
      if (apiError.response?.status === 400) {
        ...
        setSubmitError('서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해주세요.');
      } else {
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">React Hook Form으로 이메일 형식을 검증합니다</p>
          </div>
          ...
          <div>
            ...
            {errors.userNick && (
              <p className="mt-1 text-sm text-red-600">{errors.userNick.message}</p>
            )}
          </div>
